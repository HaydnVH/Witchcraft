...
// While this system SHOULD work fine on linux, I haven't had a chance to play
// with it over there.
#ifdef _WIN32
  #include <Windows.h>
#elif __linux__
  ...
  #include <unistd.h>
#else
  #pragma error("cli.cpp contains platform-specific code which may need to be rewritten.")
#endif
...
#elif __linux__
    // We need to disable canonical mode for the terminal.
    termios oldTio, newTio;
