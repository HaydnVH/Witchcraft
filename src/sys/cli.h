...
namespace cli {
  ...
  void infomore(Lock& lock, const std::string_view message);
  ...
  inline Lock warning(const std::string_view          message,
              std::optional<std::string_view> srcOverride = std::nullopt,
              std::source_location src = std::source_location::current()) {
  ...
  inline Lock error(const std::string_view          message,
            std::optional<std::string_view> srcOverride = std::nullopt,
            std::source_location src = std::source_location::current()) {
