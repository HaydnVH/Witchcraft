...
/* u8strlen is a replacement for C's 'strlen' when used with a char8_t* string.
 * Hopefully in the future this will not be neccesary.
 */
inline size_t u8strlen(const char8_t* str) {
	size_t count;
